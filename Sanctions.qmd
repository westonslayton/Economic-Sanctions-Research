...
gdp_per_country <- wb_data(gdp, country = "all", start_date = 2016, end_date = 2022) |> 
  select(-c(iso2c, iso3c, unit, obs_status, footnote)) |> filter(!is.na(GDP))
gdp_per_country |> view()
#write_xlsx(gdp_per_country, "/Users/pauldilly/Documents/Internships/Econ Research/Econ-Sanctions/data/gdp.xlsx")
...
total_exports_by_country <- 
  ...
  select(-c(iso2c, iso3c, unit, obs_status, footnote)) |> filter(!is.na(total_exports))
total_exports_by_country |> view()
#write_xlsx(total_exports_by_country, "/Users/pauldilly/Documents/Internships/Econ Research/Econ-Sanctions/data/exports.xlsx")
```
...
```{r}
#|: another-test-with-actual-export-data
