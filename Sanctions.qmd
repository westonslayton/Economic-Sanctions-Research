...
imf_total_monthly2 = data.frame()
imf_total_monthly2 <- clean_imf(file)
view(imf_total_monthly2)

file <- "data/imf_total_exports_2021A"
imf_total_annual2 <- data.frame()
imf_total_annual2 <- clean_imf(file)
view(imf_total_annual2)

file <- "data/imf_US_all_exports_2021M"
imf_us_all_monthly2 <- data.frame()
imf_us_all_monthly2 <- clean_imf(file)
view(imf_us_all_monthly2)

file <- "data/imf_US_all_exports_2021A"
imf_us_all_annual2 <- data.frame()
imf_us_all_annual2 <- clean_imf(file)
view(imf_us_all_annual2)
```
...
get_wb <- function(years, df_to_return) { 
  ...
  exports_name = "data/wb_total_exports"
