...
# sanction.list <- load_sanction(sanctions)
# beta <- load_beta(reporter, partner, provide_beta, betas)
# both <- update_sanction(sanction.list, beta, alphas)
# sanction.list <- as.data.frame(both[1])
# sanclist.ini <- both[2]
# 
...
# dt = data.table(
#   Date=seq(
#     as.Date(head(sanction.list$Date, n=1)), 
#     as.Date(tail(beta$Date, n=1)), by="day"
#   )
# )
# 
# length(sanction.list)
# view(sanction.list$Date)
# head(sanction.list$Date, n=1)
# tail(beta$Date, n=1)
```
