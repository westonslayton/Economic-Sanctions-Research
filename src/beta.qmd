...
year <- "2014" # year for which you want to gather data
...
filtered_final <- beta_filter(final, reporters, partners, year, paste0("eu", year))
```
...
```{r}
#|: combining eu data from 2014 to 2021
...
for (year in years) {
  file <- paste0("eu", year, "_beta.xlsx")
