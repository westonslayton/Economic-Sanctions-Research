...
```{r}
#|: useful for querying beta data
# will become obsolete once khi function works, as its functionality will encompass that of the code below
...
# 
# for (year in years) {
#   country <- everything(year)
#   country <- beta_filter(country, reporter, partner, year, NULL)
#   df <- rbind(df, country)
# }
```
