...
rus_gdp <- wb_gdp |> filter(country == "Russian Federation")
write_xlsx(rus_gdp, "russia_gdp.xlsx")
us_gdp <- wb_gdp |> filter(country == "United States")
write_xlsx(us_gdp, "us_gdp.xlsx")
```
