...
get_wb <- function(years, df_to_return) { 
  ...
  gdp_name <- file.path(dirname(getwd()), "data", "wb_gdp", as.character(years))
  gdp_csv = paste(gdp_name, "csv", sep = ".")
  gdp_excel = paste(gdp_name, "xlsx", sep = ".")
  write_csv(gdp, gdp_csv)
  write_xlsx(gdp, gdp_excel)
  exports_name <- file.path(dirname(getwd()), "data", "wb_total_exports", as.character(years))
  exports_csv = paste(exports_name, "csv", sep = ".")
  exports_excel = paste(exports_name, "xlsx", sep = ".")
