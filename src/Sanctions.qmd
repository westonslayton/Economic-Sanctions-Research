...
p_countries <- pairs |> distinct(reporter)
t_countries <- total |> distinct(reporter)
g_countries <- gdp |> distinct(reporter)
view(p_countries)
view(t_countries)
view(g_countries)

p_not_t <- setdiff(p_countries, t_countries)
p_not_g <- setdiff(p_countries, g_countries)
view(p_not_t)
view(p_not_g)
